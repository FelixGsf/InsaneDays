...
isStoryMode = false
function onCreate()
         makeLuaSprite('win', 'achievements/Blam you', 0, 0)  --your achiviement image
         ...
         makeLuaText('text', 'BLAM YOU', 200, 120, 10) -- change your title text
         setTextSize('text', '25') --text size 
         setTextColor('text', 'FA00E7') --change color in hex
         setObjectCamera('text', 'other')
         setProperty('text.alpha', 0)
         addLuaText('text', true)

         makeLuaText('text2', 'Win week 3 in FC in ERECT', 200, 120, 40) -- change your description text
...
function onEndSong()
     if not allowend and isStoryMode and getProperty('songMisses') < 1 then 
