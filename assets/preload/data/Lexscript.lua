...
idleoffsets = {'130', '0'} -- I recommend you have your idle offset at 0
leftoffsets = {'130', '-187'}
downoffsets = {'-20', '-165'}
upoffsets = {'10', '70'}
rightoffsets = {'-24', '-185'}
...
idle_xml_name = 'PUMPIDLE'
left_xml_name = 'PUMPRIGHT'
down_xml_name = 'PUMPDOWN'
up_xml_name = 'PUMPUP'
right_xml_name = 'PUMPLEFT'
...
name_of_character_xml = 'popayano'
name_of_character = 'popayano'
name_of_notetype = 'popayanoZZZZ'
name_of_notetype2 = 'Lexduo' -- for multiple characters singing at the same time
...
function onCreate()
	makeAnimatedLuaSprite(name_of_character, 'shoolVanilla/' .. name_of_character_xml, x_position, y_position);
