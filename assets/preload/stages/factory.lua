function onCreate()
	-- background shit
	makeAnimatedLuaSprite('SammyBG','BackGrounds/W9/images/third/SammyBg',670,580)
	addAnimationByPrefix('SammyBG','idle','Sam instance 1',24,false)
	scaleObject('SammyBG',1.1,1.1)
	makeLuaSprite('BendyBG', 'BackGrounds/W9/images/BACKBACKgROUND',-220, -100);
	scaleObject('BendyBG',1,1)

	if songName == 'Last-Reel' then
		makeAnimatedLuaSprite('JzBoy','BackGrounds/W9/images/third/JzBoy',100,580)
		addAnimationByPrefix('JzBoy','dance','Jack Copper Walk by instance 1',24,false)
		objectPlayAnimation('JzBoy','dance',false)
	end

	makeLuaSprite('BendyBG2', 'BackGrounds/W9/images/BackgroundwhereDEEZNUTSfitINYOmOUTH', -600, -150);
	scaleObject('BendyBG2',1,1)

	makeLuaSprite('BendyGround', 'BackGrounds/W9/images/MidGrounUTS', -600, -150);

	scaleObject('BendyGround',1,1)

	makeLuaSprite('Pillar', 'BackGrounds/W9/images/ForegroundEEZNUTS', 1700, -200);
	...
	if not lowQuality and songName ~= 'Terrible-Sin' then
		makeAnimatedLuaSprite('ButcherGang','BackGrounds/W9/images/third/Butchergang_Bg',-600,1200)
