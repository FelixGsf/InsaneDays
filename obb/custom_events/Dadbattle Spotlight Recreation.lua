...
function onEvent(n, v1, value2)
	if n == 'Dadbattle Spotlight Recreation' then
		...
		if val == 2 then
			...
			setProperty('dadbattleLightEvent.scale.y',2)
		elseif val == 3 then
			who = 'boyfriend'
		...
		elseif val == 4 then
			...
			setProperty('dadbattleLightEvent.scale.y',3)
		end
...
function onUpdatePost(elapsed)
	setObjectOrder('smoke1', getObjectOrder('cameos') - 1)
	setObjectOrder('smoke2', getObjectOrder('cameos') - 1)
	setObjectOrder('dadbattleLightEvent', getObjectOrder('cameos') - 1)
